...
The following map shows the distribution of life expectancy:
...
* There is a positive correlation between GDP per capita and life expectancy, with a threshold effect when GDP per capita reaches to approximately 20,000. In other words, countries with higher GDP per capita (i.e. GDP per capita > 20,000) tends to have higher life expectancy.
